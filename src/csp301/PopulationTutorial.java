...
public class PopulationTutorial extends JPanel {
    ...
    public static JFrame buildFrame() {
        ...
        try {
            ...
            t = new CSVTableReader().readTable("C:\\aaditeshwar\\personal\\iitd\\assignments\\prefuse\\prefuse-beta-20071021\\prefuse-beta\\csp301\\csp301\\data\\population.csv");
        } catch (Exception e) {
            e.printStackTrace();
            System.exit(1);
        }
        ...
        frame.setContentPane(new PopulationTutorial(t));
     ...
     */
    public PopulationTutorial(Table t) {
