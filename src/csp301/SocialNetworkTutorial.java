...
public class SocialNetworkTutorial {
    ...
    public static void main(String argv[]) {
        ...
        try {
            graph = new GraphMLReader().readGraph("C:\\aaditeshwar\\personal\\iitd\\assignments\\prefuse\\prefuse-beta-20071021\\prefuse-beta\\csp301\\csp301\\data\\socialnet.xml");
